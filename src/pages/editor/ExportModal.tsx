...
/* ============================================================
   Export — MVP export is REAL: configuration + resolved
   website structure + full-screen preview link. Automated
   code generation is clearly marked as the next phase.
   ============================================================ */
...
export default function ExportModal({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  /* Resolve the full website structure (theme tokens + resolved content) */
